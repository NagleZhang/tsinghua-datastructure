 ...
 *  Create: allocate
 *  Read: traverse, leftChildNode, rightChildNode, ParentNode
 *  Update: insertAsRoot, insertAsLeftChild, insertAsRightChild, insertAsLeftTree, insertAsRightTree
 *  Delete: removeNode
 */
struct BinNode {};
...
/*
 * Graph adjacency matrix impelete 邻接矩阵
 */
struct Vertex  {};
